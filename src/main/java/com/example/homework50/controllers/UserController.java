...
public class UserController {
    ...
    public ResponseEntity<List<User>> usersByNameEntity(@RequestParam(name = "name", required = false, defaultValue = "rr")String name){
        return new ResponseEntity<>(userService.getUsersByName(name), HttpStatus.OK);
    }

    @GetMapping("/searchbylogin")
    public ResponseEntity<List<User>> usersByLoginEntity(@RequestParam(name = "login", required = false, defaultValue = "rr")String login){
        return new ResponseEntity<>(userService.getUsersByLogin(login), HttpStatus.OK);
    }
    @GetMapping("/searchbyemail")
    public ResponseEntity<User> userByEmailEntity(@RequestParam(name = "email", required = false, defaultValue = "rr")String email){
